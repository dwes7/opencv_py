...
class Sliders:
    ...
    def __init__(self):
        ...
        # SECTION 1
        ###############################################################
        self.num_of_sliders = 6  # The number of Slider objects that
        ...
        self.Sf = mySlider(self.num_of_sliders, 1,
                         255,  0, P.hu0, 1, 'Hue Upper')
        self.Sf = mySlider(self.num_of_sliders, 2,
                         255, 0, P.su0, 1, 'Saturation Upper')
        self.Sf = mySlider(self.num_of_sliders, 3,
                         255,  0, P.vu0, 1, 'Value upper')
        self.Sf = mySlider(self.num_of_sliders, 4,
                         255,  0, P.hl0, 1, 'Hue Lower')
        self.Sf = mySlider(self.num_of_sliders, 5,
                         255,  0, P.sl0, 1, 'Saturation Lower')
        self.Sf = mySlider(self.num_of_sliders, 6,
                         255,  0, P.vl0, 1, 'Value Lower')

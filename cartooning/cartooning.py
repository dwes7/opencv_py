...
def cartoonize_image(img, ds_factor=4, sketch_mode=False):
	...
	for i in range(num_repetitions):
		 # bilateral filter is better than the Gaussian filter
		 # becuase it preserves the edges in the image.the
		 # it takes the average of all the SIMILAR pixels
		 # in the neigborhood and not the averate of ALL the pixels
		 # like with the Gaussian filter
